                ...
                <div class="col-lg-9">
                    <div class="blog-content-wrapper">
                        <div class="row mtn-25">
                            ...
                            */
                                $geBlogPost = $blog->getAllBlogPost();
                                if ($geBlogPost) {
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="blog-item">
                                    <figure class="blog-item__thumb">
                                        <a href="blog-details-sidebar.php?blogid=<?php echo $result['id']; ?>"><img src="admin/<?php echo $result['image']; ?>" alt="<?php echo $result['title']; ?>" /></a>
                                    </figure>
                                    <div class="blog-item__info">
                                        ...
                                        <h2 class="post-title"><a href="blog-details-sidebar.php?blogid=<?php echo $result['id']; ?>"><?php echo $result['title']; ?></a></h2>

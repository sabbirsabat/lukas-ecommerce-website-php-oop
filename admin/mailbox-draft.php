                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12 mg-b-15">
                                <div class="btn-group">
                                    <a href="mailbox-draft.php"><button class="btn btn-default btn-sm"><i class="fa fa-refresh"></i> Refresh</button></a>
                                 <!--    
                            ...
                            <table class="table table-hover table-mailbox">
                                <tbody>
                                    <?php 
                                         ...
                                         * Show Mail List
                                         */                                
                                            $getDraft = $cntct->getDraftList();
                                            if ($getDraft) {
                                                $i = 0;
                                                while ( $result = $getDraft->fetch_assoc()) {
                                                    $i++;
                                        ?>
                                    <tr class="unread">
                                        <td class="">

...
<?php
$user = new User();
    if (!isset($_GET['usrprfle']) || $_GET['usrprfle'] == NULL) {
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="review-tab-pro-inner">
                        ...
                        <?php 
                            ...
                            /**
                             * User by id for editable value showing method call
                             */
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="text-center custom-pro-edt-ds">
                                                               <a href="user-list.php"> <button type="button" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Back to Userlist</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                            ...
                            <table class="table table-hover table-mailbox">
                                <tbody>
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td> <a onclick="return confirm('Move this mail to seen box ?')" href="mailbox-seen.php?seenid=<?php echo $result['id']; ?>"> <button title="Seen" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></button></a></td>

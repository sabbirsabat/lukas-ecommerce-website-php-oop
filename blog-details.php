                                ...
                                <div class="col-md-3 col-lg-2 order-1 order-md-0">
                                    <div class="author-info mt-sm-40">
                                        <div class="author-thumb">
                                            <img src="admin/<?php echo $result['image']; ?>" alt="<?php echo $result['author']; ?>" />
                                        </div>
                                        <div class="author-txt">
                                            <h5><?php echo $result['author']; ?>
                                            ...
                                            <h5>
                                                <span class="designation">Category:
                                                    <?php echo $result['blog_category_name']; ?>
                                                </span>
                                            </h5>
